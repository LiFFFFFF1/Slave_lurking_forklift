 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
   Timeout value 
   */
//#define HSE_STARTUP_TIMEOUT   ((uint16_t)0x0500) /*!< STM32F10X-Time out for HSE start up */
#define HSE_STARTUP_TIMEOUT ((uint16_t)0xFFFF)      /*!< GD32F10X-Time out for HSE start up */
