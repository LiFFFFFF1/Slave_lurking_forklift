...
/***************************************************************************************
*函    数: void Bat_CommReadMecData(USART_STRU *Serial,QUEUE *QUEUE_com)
*功    能: 读取队列缓存数据
*参    数:         
*作    者: 
*修改时间: 
...
/***************************************************************************************
*函    数: void Bat_Comm_MecSend_Ask(void)
*功    能: 发送进程
*参    数:      
*作    者: 
*修改时间: 
...
void Bat_Comm_MecSend_Ask(void)
{
    ...
    u8 bat_ask_buf[7]= {0x3A, 0x16, 0x22, 0x01, 0xAA, 0xE3, 0x00};// 自定义协议
...
void Bat_Comm_Mec_Handler(void)
{
    ...
    Bat_CommReadMecData(Serial, QUEUE_com);               // 自定义解码
